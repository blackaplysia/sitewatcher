...
def main():
    ...
    sp_set.add_argument('name', nargs=1, metavar='NAME', help='site name (or \'all\', \'global\')')
    ...
    sp_unset.add_argument('name', nargs=1, metavar='NAME', help='site name (or \'all\', \'global\')')
    ...
    sp_variables.add_argument('name', nargs=1, metavar='NAME', help='site name (or \'all\', \'global\')')
